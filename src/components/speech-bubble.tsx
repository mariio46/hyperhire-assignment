...
const speechBubbleVariants = cva('relative inline-flex rounded-lg px-4 py-2 text-lg font-black', {
    variants: {
        ...
        arrowPosition: {
            ...
            middle: '[&>[data-slot=arrow]]:absolute [&>[data-slot=arrow]]:-bottom-3 [&>[data-slot=arrow]]:left-1/2 [&>[data-slot=arrow]]:size-3 [&>[data-slot=arrow]]:-translate-x-1/2 [&>[data-slot=arrow]]:-translate-y-2 [&>[data-slot=arrow]]:rotate-45',
        },
    },
    defaultVariants: {
        variant: 'default',
