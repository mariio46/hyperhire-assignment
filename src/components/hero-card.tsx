  ...
  return (
    <div className={cn('flex max-w-80 flex-col justify-center space-y-9 rounded-xl bg-white p-9', className)}>
      ...
      <div className="inline-flex flex-wrap items-center justify-center gap-1">
        ...
        <div className="inline-flex justify-center rounded-md border border-[#C1C5CF] px-3 py-1">인스타그램 관리</div>
        <div className="inline-flex justify-center rounded-md border border-[#C1C5CF] px-3 py-1">트위터 관리</div>
        <div className="inline-flex justify-center rounded-md border border-[#C1C5CF] px-3 py-1">블로그 글 작성</div>
      </div>
    </div>
  );
};
